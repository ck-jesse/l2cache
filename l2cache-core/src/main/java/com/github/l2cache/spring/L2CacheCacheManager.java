...
import com.github.l2cache.cache.expire.CacheExpiredListener;
import com.github.l2cache.cache.expire.DefaultCacheExpiredListener;
import com.github.l2cache.CacheBuilder;
import com.github.l2cache.CacheConfig;
import com.github.l2cache.content.CacheSupport;
...
public class L2CacheCacheManager implements CacheManager {
    ...
    protected Cache createL2CacheSpringCache(String cacheType, String cacheName) {
        ...
        com.github.l2cache.Cache cache = this.getL2CacheInstance(cacheType, cacheName, expiredListener);
     ...
     */
    private com.github.l2cache.Cache getL2CacheInstance(String cacheType, String cacheName, CacheExpiredListener expiredListener) {
        com.github.l2cache.Cache cache = CacheSupport.getCache(cacheType, cacheName);
        if (null != cache) {
            return cache;
        }
