...
import com.coy.l2cache.jd.hotkey.dashboard.service.KeyService;
import com.coy.l2cache.jd.hotkey.dashboard.service.RuleService;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.ibm.etcd.api.Event;
import com.coy.l2cache.jd.hotkey.common.configcenter.ConfigConstant;
...
import com.coy.l2cache.jd.hotkey.dashboard.mapper.KeyRecordMapper;
import com.coy.l2cache.jd.hotkey.dashboard.mapper.StatisticsMapper;
...
import com.coy.l2cache.jd.hotkey.dashboard.netty.HotKeyReceiver;
import com.coy.l2cache.jd.hotkey.dashboard.util.CommonUtil;
import com.coy.l2cache.jd.hotkey.dashboard.util.DateUtil;
import com.coy.l2cache.jd.hotkey.dashboard.util.PageUtil;
import com.coy.l2cache.jd.hotkey.dashboard.util.RuleUtil;
...
public class KeyServiceImpl implements KeyService {
    ...
    public int delKeyByUser(KeyTimely keyTimely) {
        ...
        if (configCenter.get(etcdKey) == null) {
            ...
            configCenter.putAndGrant(etcdKey, com.coy.l2cache.jd.hotkey.common.tool.Constant.DEFAULT_DELETE_VALUE, 1);
        }
