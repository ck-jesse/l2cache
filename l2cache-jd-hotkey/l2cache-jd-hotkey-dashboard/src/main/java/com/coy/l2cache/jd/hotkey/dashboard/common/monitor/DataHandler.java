package com.coy.l2cache.jd.hotkey.dashboard.common.monitor;
...
import com.coy.l2cache.jd.hotkey.dashboard.common.domain.IRecord;
...
import com.coy.l2cache.jd.hotkey.dashboard.mapper.SummaryMapper;
...
public class DataHandler {
    ...
    private KeyRecord handHotKey(IRecord record) {
        ...
        if (type == 0) {
            //如果是客户端删除时发出的put指令
            if (com.coy.l2cache.jd.hotkey.common.tool.Constant.DEFAULT_DELETE_VALUE.equals(value)) {
